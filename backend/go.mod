...
require (
	...
	github.com/formatho/agent-orchestrator/packages/agent-runner v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/formatho/agent-orchestrator/packages/agent-skills v0.0.0 // indirect
	github.com/formatho/agent-orchestrator/packages/goagent v0.0.0 // indirect
...
replace (
	...
	github.com/formatho/agent-orchestrator/packages/agent-runner => ../packages/agent-runner
	...
	github.com/formatho/agent-orchestrator/packages/goagent => ../packages/goagent
